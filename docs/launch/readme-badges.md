...
[![Version](https://img.shields.io/badge/version-0.7.0--beta.7-blue)](https://github.com/Kartik24Hulmukh/AccessDoc/releases/tag/v0.7.0-beta.7)
...
| Badge | Source | Notes |
|-------|--------|-------|
| CI | GitHub Actions workflow `accessdoc-ci.yml` | Requires the CI workflow to be active |
...
```markdown
[![GitHub Action](https://img.shields.io/badge/GitHub%20Action-AccessDoc%20Evidence%20Gate-blue)](https://github.com/marketplace/actions/accessdoc-evidence-gate)
```
