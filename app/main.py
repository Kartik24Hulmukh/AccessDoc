...
# AI remediation has its own pool: a slow frontier-model call must never starve PDF generation.
REMEDIATION_CAPACITY=threading.BoundedSemaphore(int(os.getenv('MAX_CONCURRENT_REMEDIATIONS','8')))
